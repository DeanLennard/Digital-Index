...
export const metadata = {
    title: "Healthcare & Clinics Digital Index | Free Baseline Snapshot",
    description:
        "GP, dental, physio, optometry or private clinic? Benchmark your digital operations in minutes. Get a free snapshot with clear actions for bookings, reminders, intake forms, compliance and patient comms.",
    alternates: { canonical: "/industries/healthcare-clinics" },
    openGraph: {
        ...
        url: "https://www.digitalindex.co.uk/industries/healthcare-clinics",
        type: "website",
    },
};
...
const faqs = [
    ...
    {
        q: "NHS or private?",
        a: "Both. Guidance adapts to clinics running private lists, NHS contracts, or mixed models.",
    },
    {
        q: "Can the team access results?",
        a: "Yes. On Premium you can invite unlimited team members, view trends and export snapshots.",
    },
];
...
function JsonLd() {
    const jsonLd = {
        ...
        url: "https://www.digitalindex.co.uk/industries/healthcare-clinics",
        description:
            "Benchmark your clinic’s digital operations and get a free snapshot with clear next steps.",
        breadcrumb: {
            "@type": "BreadcrumbList",
            itemListElement: [
                { "@type": "ListItem", position: 1, name: "Industries", item: "https://www.digitalindex.co.uk/industries" },
                { "@type": "ListItem", position: 2, name: "Healthcare & Clinics" },
            ],
        },
        mainEntity: {
            "@type": "FAQPage",
            name: "Healthcare & Clinics — FAQs",
        ...
        <section>
                ...
                <div className="grid lg:grid-cols-2 gap-10 items-center">
                    ...
                    <div className="rounded-xl bg-white shadow-sm p-4 border">
                        <div className="aspect-[16/10] w-full rounded-md bg-[var(--bg)] grid place-items-center text-gray-500">
                            <img src="/how-it-works.png" alt="Healthcare preview" title="Healthcare preview" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="mx-auto max-w-6xl px-4 sm:px-6 py-14">
                ...
                <p className="mt-2 text-gray-700 max-w-prose">
                    Your snapshot prioritises actions that reduce no-shows and admin while improving patient experience:
                </p>
