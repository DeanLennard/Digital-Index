...
const FORMATS = [
    {
        key: "remote-2h",
        name: "Remote Review (2 hours)",
        blurb: "Zoom session. Review of your tools, posture, and quick wins.",
        bullets: ["Score deep-dive", "Quick wins list", "Follow-up summary"],
    },
    {
        key: "half-day",
        name: "Half-day Deep Dive",
        blurb: "Half-day, remote or onsite. Collaborative working session.",
        bullets: ["Workshop format", "Roadmap for 90 days", "Stakeholder Q&A"],
    },
    {
        key: "full-day",
        name: "Full-day Onsite",
        blurb: "Full-day, onsite. Hands-on review across teams and tooling.",
        bullets: ["End-to-end review", "Prioritised action plan", "Exec read-out"],
    },
] as const;
        ...
        <div className="space-y-6">
            ...
            <section className="rounded-lg border bg-white p-5">
                ...
                <p className="mt-2 text-gray-700">
                    Get an in-depth, practical review from an SME specialist. We’ll benchmark you, identify the highest-ROI fixes,
                    and leave you with a clear, prioritised plan. Use us directly or let us connect you with a trusted MSP partner.
                </p>
            </section>

            {/* Informational only — NO PRICING */}
            <section className="rounded-lg border bg-white p-5">
                <h2 className="text-lg font-semibold text-[var(--navy)]">Typical formats</h2>
            ...
            <section id="request" className="rounded-lg border bg-white p-5">
                ...
                <form action={createConsultationLead} className="mt-3 grid gap-3 md:grid-cols-2">
                    <input type="hidden" name="source" value="specialist-review" />
                    ...
                    {/* Keep field name "package" for backend compatibility, but display as "Interested in" */}
                    <label className="text-sm">
                        Interested in
